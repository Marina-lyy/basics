...
def getMsg():
    ...
    index = len(mails)
    # retr负责返回一个具体索引号的一封邮件的内容，此内容不具有可读性
    ...
    if indent == 0:
        for header in ['From', 'To', 'Subject']:
            ...
            if value:
                ...
                # 如果是From和To字段， 则内容大概是“我的邮箱<XXXXXXXX@qq.com>”这种格式
                else:
                    hdr, addr = parseaddr(value)
                    name = decode_header(hdr)
                    # 最终返回形如“我的邮箱<xxxx@qq.com>的格式
